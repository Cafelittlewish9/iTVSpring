					...
					<form id="SignUp_form" action="<c:url value='/registry'/>"
						...
						<div id="l_input1" class="input-group">
							<span class="input-group-addon" id="basic-addon1">帳號</span> <input
								value="${errorMsg}" id="memberAccount" type="text"
								name="memberAccount" class="form-control"
								placeholder="帳號限英文字母、數字，長度必須在6-20之間"
								aria-describedby="basic-addon1">
						</div>

						<div id="l_input2" class="input-group">
							<span class="input-group-addon" id="basic-addon1">密碼</span> <input
								value="${errorMsg}" id="memberPassword" type="text"
								name="memberPassword" class="form-control" maxlength="20"
								placeholder="密碼限英文字母、數字，長度必須在8-20之間"
								aria-describedby="basic-addon1">
						</div>

						<div id="l_input3" class="input-group">
							<span class="input-group-addon" id="basic-addon1">E-mail</span> <input
								value="${errorMsg}" id="memberEmail" type="text"
								name="memberEmail" class="form-control" maxlength="40"
								placeholder="此項為必填欄位" aria-describedby="basic-addon1">
						</div>
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon1">暱稱</span> <input
								value="${param.memberNickname}" id="memberNickname" type="text"
								name="memberNickname" class="form-control" maxlength="40"
								placeholder="請輸入" aria-describedby="basic-addon1">
						</div>
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon1">生日</span> <input
								value="${param.memberBirthday}" id="memberBirthday" type="date"
								name="memberBirthday" class="form-control" placeholder="請輸入"
								aria-describedby="basic-addon1">
						</div>
						<div class="input-group">
...
<!-- 						<input value="Insert" type="hidden" name="operation" -->
